...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of MMDeviceImageManager.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Muthuraj Muthulingam/MMDeviceImageManager'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Muthuraj Muthulingam' => 'muthurajmuthulingam@gmail.com' }
  s.source           = { :git => 'https://github.com/Muthuraj Muthulingam/MMDeviceImageManager.git', :tag => s.version.to_s }
